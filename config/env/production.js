...
module.exports = {
	db: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/e-amity',
	assets: {
		lib: {
			css: [
				...
				'public/lib/Progress.js/minified/progressjs.min.js',
